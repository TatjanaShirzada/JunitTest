	...
	static void rateZahl(int wertebereich){
		...
		while (zufallsZahl != eingabe){
			if (zufallsZahl<eingabe){
				...
				System.out.println("Leider nein, die Zahl ist groesser, du hattest "+zaehler+" Versuche gehabt. Versuche es nochmal!");
			}
			
			eingabe = scanner.nextInt(); //erneute Eingabe
			zaehler++; //ZŠhler bei jedem Durchlauf um eins erhšht
		}
		System.out.println("Bingo! Du hattest " +zaehler+ " Durchgaenge gebraucht"); //Eingabe war richtig
	}
